...
<style>
  ...
  .logo-wrapper{display:flex;justify-content:center;align-items:center;padding:6px 0 2px;width:100%}
  .main-logo{height:52px;width:auto;object-fit:contain;filter:drop-shadow(0 0 8px rgba(255,215,0,0.4))}
